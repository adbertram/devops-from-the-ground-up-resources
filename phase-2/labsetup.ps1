...
$templatePath = "$env:TEMP\phase2lab.json"
$url = 'https://raw.githubusercontent.com/adbertram/devops-from-the-ground-up-resources/master/phase-1/phase2lab.json'
